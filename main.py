...
expname  = 'Urban+Grass, Sounding 2'
...
vvm = VVMTools("/data/mlcloud/pike/VVM/DATA/5_2hetero")


bl_point5 = vvm.func_time_parallel(vvm.blPointfive, t_range, domain_range=domain_range) / 1000
bl_tke=vvm.blOther('TKE', 0.3, t_range, domain_range = domain_range) / 1000
bl_ens=vvm.blOther('ENS', 3e-5, t_range, domain_range = domain_range) / 1000
bl_grad=vvm.func_time_parallel(vvm.blGrad, t_range, domain_range = domain_range) / 1000
